...
// ROUTE 1. to fetch all notes of logged user using "/handlytask/tasks/fetchallnotes" using GET request and Login required
...
// ROUTE 2. to add a new task using "/handlytask/tasks/addtask" using POST request and Login required
...
// ROUTE 3. to update a Task using "/handlytask/tasks/updatetask" by PUT request and Login required
...
// ROUTE 4. to delete a Task using "/handlytask/tasks/deletetask" by DELETE request and Login required
